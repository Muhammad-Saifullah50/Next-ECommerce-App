...
const AboutPage = () => {
    ...
    return (<>
        ...
        <div className={textstyles.container}>
            ...
            <p>DEWALT has always been synonymous with innovation. We invest heavily in research and development, constantly pushing the boundaries of what's possible in power tool technology. Our team of engineers and designers work tirelessly to develop new features, improve efficiency, and enhance user experience. We listen to the needs of professionals like you, ensuring that our products address the challenges you face on the job site.</p>
            ...
            <p>Our commitment to your success doesn't end with the purchase of a DEWALT product. We take pride in offering exceptional customer service and support throughout your entire ownership journey. Whether you need assistance with product selection, troubleshooting, or repairs, our knowledgeable team is always here to help. We stand by the quality of our products and provide comprehensive warranties to ensure your satisfaction.</p>
            ...
            <p> <em> Thank you for choosing DEWALT. Let's power your success, together.</em></p>
        </div>
        <Footer />
    </>)
}
