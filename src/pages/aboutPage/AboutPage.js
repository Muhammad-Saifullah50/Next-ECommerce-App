...
const AboutPage = () => {
    ...
    return (<>
        ...
        <div className="categorypage-banner ">
            <h2 className='text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-extrabold'> About Us </h2>
        </div>
        <div className="container w-[95%] mx-auto  ">
            <h1 className='text-2xl font-bold my-4'>Welcome to DEWALT: Powering Your Success</h1>
            ...
            <h2 className='text-xl font-semibold my-2 text-yellow-500'>Our Commitment to Excellence</h2>
            ...
            <h2 className='text-xl font-semibold my-2 text-yellow-500'>Unleashing the Power of Innovation:</h2>
            ...
            <h2 className='text-xl font-semibold my-2 text-yellow-500'>A Comprehensive Range of Solutions:</h2>
            ...
            <h2 className='text-xl font-semibold my-2 text-yellow-500'>Building a Community of Professionals:</h2>
            ...
            <h2 className='text-xl font-semibold my-2 text-yellow-500'>Service and Support You Can Trust:</h2>
            ...
            <h2 className='text-xl font-semibold my-2 text-yellow-500'>Together, We Build:</h2>
